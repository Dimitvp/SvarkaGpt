        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_GameStates_StateGameId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlayerStates_GameStates_GameStateGameId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeckForeignKey = table.Column<int>(type: "int", nullable: true),
                    GameId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    HandForeignKey = table.Column<int>(type: "int", nullable: true),
                    PlayedCardsForeignKey = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cards_GameStates_DeckForeignKey",
                        column: x => x.DeckForeignKey,
                        principalTable: "GameStates",
                        principalColumn: "GameId");
                    table.ForeignKey(
                        name: "FK_Cards_GameStates_PlayedCardsForeignKey",
                        column: x => x.PlayedCardsForeignKey,
                        principalTable: "GameStates",
                        principalColumn: "GameId");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Cards_PlayerStates_HandForeignKey",
                        column: x => x.HandForeignKey,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cards_HandForeignKey",
                table: "Cards",
                column: "HandForeignKey");

            migrationBuilder.CreateIndex(
                name: "IX_Cards_PlayedCardsForeignKey",
                table: "Cards",
                column: "PlayedCardsForeignKey");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerStates_GameStateGameId",
                table: "PlayerStates",
